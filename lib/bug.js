...
exports.Bug.prototype = {
    ...
    draw: function () {
        ...
        label.setAttribute('class', 'bug text-link');
        label.setAttribute('href', 'https://bugzilla.mozilla.org/show_bug.cgi?id='+this.id);
        label.setAttribute('value', this.id+' - '+this.summary);
